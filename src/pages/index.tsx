      ...
      <main className="min-h-screen">
        <section className="min-h-screen flex flex-col lg:justify-center px-4">
          <div className="max-lg:fixed max-lg:pointer-events-none max-lg:top-0 max-lg:left-0 max-lg:right-0 max-lg:bottom-0 flex flex-col lg:flex-row items-center justify-center lg:my-16 gap-8">
            <Link 
              className={`uppercase text-center pointer-events-auto lg:translate-x-full`}
            ...
            <Logo />
            <Link className={`uppercase text-center pointer-events-auto lg:-translate-x-full`} href="https://goo.gl/maps/yx7ytZ2okDUuF33q7" target="_blank">The Centre for<br/>Performing Arts</Link>
          </div>
        </section>
