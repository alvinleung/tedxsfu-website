  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full bg-white font-normal text-black">
        ...
        <SectionLayout>
          <h3 className="col-span-3 2xl:col-span-4 col-start-1 mb-24 text-lead md:col-span-2 md:col-start-2 xl:col-start-4">
            And our larger, proud and hungry team of 21
          </h3>
          <div className="col-span-3 2xl:col-span-4 col-start-1 grid gap-4 md:col-start-2 md:grid-cols-2 xl:col-start-4">
            {teams.map((team, i) => (
