...
const TicketIcon = (props: Props2) => {
  ...
  const [openAnim, setOpenAnim] = useState({top: pathVariants.topOpen, bottom: pathVariants.bottomOpen});
  const [wasPressed, setWasPressed] = useState(false);
  useEffect(() => {
    setOpenAnim(props.isPressed ? {top: pathVariants.topLift, bottom: pathVariants.bottomLift} : {top: pathVariants.topOpen, bottom: pathVariants.bottomOpen});
  ...
  >
    ...
    >
      ...
      <motion.path
        ...
        animate={{
          ...
          d: props.isPressed ? pathVariants.topPress : props.isHovered ? openAnim.top : pathVariants.topClose 
        }}
        transition={{
    ...
    <motion.path
      ...
      animate={{ 
        stroke: props.isAboutPage ? "#999" : "#FFF",
        d:  props.isPressed ? pathVariants.bottomPress : props.isHovered ? openAnim.bottom : pathVariants.bottomClose 
      }}
      transition={{
        ease: AnimationConfig.EASING_INVERTED,
        duration: AnimationConfig.NORMAL
...
const TicketCTA = ({ isHighlighted, isAboutPage }: Props) => {
  ...
  return (
    <motion.a
      ...
      onPointerDown={e => {setPressed(true)}}
    ...
    >
      ...
      >
        <TicketIcon isAboutPage={isAboutPage} isHovered={hover} isPressed={pressed}/>
      </div>
      ...
      <div className="flex h-[28px] flex-col items-start whitespace-nowrap pl-[9px] pr-[9px] mix-blend-exclusion">
        <div className="mt-[-1px] text-nav uppercase leading-none pointer-events-none">
          Get Tickets
        </div>
        <div
          className="mt-[3px] flex flex-col text-nav-s leading-none tracking-wide pointer-events-none"
          style={{
