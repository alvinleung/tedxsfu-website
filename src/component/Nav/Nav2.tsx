        ...
        <AnimatePresence>
          {!isAboutPage ? (
            <motion.svg 
              ...
              <motion.path d="M763.3,182.3c-0.8-8.1-4.4-14.6-10.8-19.4c-6.4-4.8-14.4-7.2-24-7.2c-6.8,0-12.8,1.2-17.9,3.5c-5.2,2.3-9.2,5.6-12.1,9.7
              ...
              <motion.path d="M804.1,291.9V145.7h84.5v12h-71.2v55H882v12h-64.6v67.1L804.1,291.9L804.1,291.9z"/>
              <motion.path d="M1008.5,145.7h13.3v96.8c0,9.9-2.3,18.8-7,26.6c-4.7,7.8-11.1,14-19.4,18.5c-8.3,4.5-17.9,6.7-28.9,6.7
              ...
              <motion.path d="M186.8,183.2H146v-37.4h126.6v37.4h-40.9v108.6h-44.9C186.8,291.7,186.8,183.2,186.8,183.2z"/>
              <motion.path d="M279.5,145.8h122.9v37.4h-78v18.2h78v34.8h-78v18.2h78v37.4H279.5V145.8z"/>
              <motion.path d="M410,145.8h73.7c48.6,0,65.8,36,65.8,72.8c0,44.8-23.7,73.2-74.5,73.2h-65V145.8z M454.9,254.3h17.6
                c28,0,32.1-22.7,32.1-36.4c0-9.2-2.9-34.7-35.3-34.7H455v71.1H454.9z"/>
              <motion.path d="M614,235.8L600.3,213l-13.4,22.8H554l31.2-46l-30.1-44H588l12.2,21.8l12.5-21.8h32.9l-30.1,44l31.2,46H614z"/>
