...
const Hamburger = () => {
  ...
  const pathVariants = {
    ...
    a: {
      d: !open
        ? "M4 5 L20 5 L20 7 L4 7 L4 5Z"
        : [
            "M4 5 L20 5 L20 7 L4 7 L4 5Z",
            "M4 11 L20 11 L20 13 L4 13 L4 11Z",
            "M7.0502 5.63605L18.3639 16.9498L16.9497 18.364L5.63599 7.05026L7.0502 5.63605Z",
          ],
      opacity: 1,
    },
    b: {
  ...
  const pathVariants2 = {
    ...
    a: {
      d: !open
        ? "M4 17 L20 17 L20 19 L4 19 L4 17Z"
        : [
            "M4 17 L20 17 L20 19 L4 19 L4 17Z",
            "M4 11 L20 11 L20 13 L4 13 L4 11Z",
            "M7.0502 5.63605L18.3639 16.9498L16.9497 18.364L5.63599 7.05026L7.0502 5.63605Z",
    ...
    a: {
      d: !open
        ...
        : [
            "M4 11 L20 11 L20 13 L4 13 L4 11Z",
            "M4 11 L20 11 L20 13 L4 13 L4 11Z",
            "M5.63599 16.9498L16.9497 5.63605L18.3639 7.05026L7.0502 18.364L5.63599 16.9498Z",
          ],
      opacity: 1,
    },
    b: {
  ...
  return (
    <motion.svg fill="white" className="h-6 w-6">
      <motion.path
