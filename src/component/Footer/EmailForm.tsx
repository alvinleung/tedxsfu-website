...
const EmailForm = ({ isDarkMode }: Props) => {
  ...
  return (
    <motion.form
      layout
      className={`backdrop-blur-sm text-micro ${isDarkMode ? "bg-neutral-900/25 text-white/50" : "text-black/50"} overflow-hidden rounded-lg
      ...
      >Thanks for subscribing!</motion.p>}
      </AnimatePresence>
    </motion.form>
  );
};
